"""
Original Push-up Counter Code (WITH THE BUG)
This is your original code so you can test it and see the issue
"""
...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            # ORIGINAL CODE WITH THE BUG - MISSING 'ready' STATE HANDLER
            if state == 'get_ready':
            ...
            # BUG: No handler for state == 'ready', so it gets stuck!
